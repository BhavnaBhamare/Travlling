					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								<li class="active"><a href="hoteldash.jsp">Home</a></li>

								<li><a href="addhotel.jsp">Add Hotel</a></li>
								<li><a href="viewhotel.jsp">View Hotel</a></li>
								<li><a href="profilehoteladmin.jsp">Profile Admin</a></li>
								<li><a href="userrequesthotel.jsp">User Request</a></li>
