					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								<li class="active"><a href="cabsdash.jsp">Home</a></li>

								<li><a href="addcab.jsp">Add Cabs</a></li>
								<li><a href="viewcab.jsp">View Cabs</a></li>
								<li><a href="profilecabadmin.jsp">Profile Admin</a></li>
								<li><a href="userrequestcab.jsp">User Request</a></li>
